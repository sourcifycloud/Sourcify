...
const lastTag = (await exec('git describe --tags --match "sourcify@*" --abbrev=0')).stdout.trim();
...
packageMap['monorepo-root'].version = packageMap['sourcify'].version;
...
console.log(packageMap['sourcify'].nextVersion);
