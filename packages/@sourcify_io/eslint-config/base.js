...
const config = (module.exports = {
	...
	plugins: [
		 ...
		 * https://github.com/ivov/eslint-plugin-sourcify-local-rules
		 */
		'eslint-plugin-sourcify-local-rules',
	],
	...
	rules: {
		 ...
		 */
		'sort-imports': 'off', // @TECH_DEBT: Enable, prefs to be decided - sourcify-5821
		 ...
		 */
		'@typescript-eslint/triple-slash-reference': 'off', // @TECH_DEBT: Enable, disallowing in all cases - sourcify-5820
		...
		//   eslint-plugin-sourcify-local-rules
		// ----------------------------------
		'sourcify-local-rules/no-uncaught-json-parse': 'error',

		'sourcify-local-rules/no-json-parse-json-stringify': 'error',

		'sourcify-local-rules/no-unneeded-backticks': 'error',

		'sourcify-local-rules/no-interpolation-in-regular-string': 'error',

		'sourcify-local-rules/no-unused-param-in-catch-clause': 'error',
