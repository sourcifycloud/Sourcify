...
import { Credentials, NodeExecuteFunctions } from 'sourcify-core';
...
export class CredentialsHelper extends ICredentialsHelper {
	...
	async preAuthentication(
		...
		const isTestingCredentials =
			node?.parameters?.temp === '' && node?.type === 'sourcify-nodes-base.noOp';
	...
	async testCredentials(
		...
		if (credentialTestFunction.nodeType) {
			...
			nodeType = this.nodeTypes.getByNameAndVersion('sourcify-nodes-base.noOp');
		}
