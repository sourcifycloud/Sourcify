...
import type { ICredentialDataDecryptedObject, ICredentialTypes } from 'sourcify-workflow';
import { deepCopy, LoggerProxy as Logger, jsonParse } from 'sourcify-workflow';
