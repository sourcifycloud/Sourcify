import type { TEntitlement, TLicenseBlock } from '@sourcify_io/license-sdk';
import { LicenseManager } from '@sourcify_io/license-sdk';
import type { ILogger } from 'sourcify-workflow';
	...
	async init(instanceId: string) {
		...
		try {
			this.manager = new LicenseManager({
				...
				productIdentifier: `sourcify-${sourcify_VERSION}`,
				autoRenewEnabled,
				autoRenewOffset,
				logger: this.logger,
				loadCertStr,
