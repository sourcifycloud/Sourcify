...
import { LoggerProxy, jsonParse } from 'sourcify-workflow';
...
class Server extends AbstractServer {
	...
	frontendSettings: IsourcifyUISettings;
	 ...
	 */
	getSettingsForFrontend(): IsourcifyUISettings {
	...
	async configure(): Promise<void> {
		...
		this.frontendSettings.versionCli = sourcify_VERSION;
		...
		this.app.get(
			...
			ResponseHelper.send(
				async (req: express.Request, res: express.Response): Promise<IsourcifyUISettings> => {
...
export async function start(): Promise<void> {
	...
	const diagnosticInfo: IDiagnosticInfo = {
		...
		sourcify_multi_user_allowed: isUserManagementEnabled(),
	...
	if (inDevelopment && process.env.sourcify_DEV_RELOAD === 'true') {
