...
import type { IProcessMessage } from 'sourcify-core';
import { BinaryDataManager, WorkflowExecute } from 'sourcify-core';
		...
		const workflowExecution: PCancelable<IRun> = new PCancelable(
			async (resolve, reject, onCancel) => {
				...
				try {
					...
					// We don't want errors here to crash sourcify. Just log and proceed.
