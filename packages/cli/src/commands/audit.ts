...
export class SecurityAudit extends BaseCommand {
	static description = 'Generate a security audit report for this sourcify instance';

	static examples = [
		'$ sourcify audit',
		'$ sourcify audit --categories=database,credentials',
		'$ sourcify audit --days-abandoned-workflow=10',
	];
