...
import { PLACEHOLDER_EMPTY_WORKFLOW_ID } from 'sourcify-core';
import type { IWorkflowBase } from 'sourcify-workflow';
import { ExecutionBaseError } from 'sourcify-workflow';
...
export class Execute extends BaseCommand {
	...
	static examples = ['$ sourcify execute --id=5', '$ sourcify execute --file=workflow.json'];
