...
import type { ITaskData } from 'sourcify-workflow';
import { sleep } from 'sourcify-workflow';
...
export class ExecuteBatch extends BaseCommand {
	...
	static examples = [
		'$ sourcify executeBatch',
		'$ sourcify executeBatch --concurrency=10 --skipList=/data/skipList.txt',
		'$ sourcify executeBatch --debug --output=/data/output.json',
		'$ sourcify executeBatch --ids=10,13,15 --shortOutput',
		'$ sourcify executeBatch --snapshot=/data/snapshots --shallow',
		'$ sourcify executeBatch --compare=/data/previousExecutionData --retries=2',
	];
	...
	initializeLogs() {
		...
		process.stdout.write('              sourcify test workflows\n');
		process.stdout.write('**********************************************\n');
		process.stdout.write('\n');
