...
import { Credentials, UserSettings } from 'sourcify-core';
...
export class ExportCredentialsCommand extends BaseCommand {
	...
	static examples = [
		'$ sourcify export:credentials --all',
		'$ sourcify export:credentials --id=5 --output=file.json',
		'$ sourcify export:credentials --all --output=backups/latest.json',
		'$ sourcify export:credentials --backup --output=backups/latest/',
		'$ sourcify export:credentials --all --decrypted --output=backups/decrypted.json',
	];
