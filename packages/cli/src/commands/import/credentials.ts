...
import { Credentials } from 'sourcify-core';
import fs from 'fs';
...
import type { ICredentialsEncrypted } from 'sourcify-workflow';
...
export class ImportCredentialsCommand extends BaseCommand {
	...
	static examples = [
		'$ sourcify import:credentials --input=file.json',
		'$ sourcify import:credentials --separate --input=backups/latest/',
		'$ sourcify import:credentials --input=file.json --userId=1d64c3d2-85fe-4a83-a649-e446b07b3aae',
		'$ sourcify import:credentials --separate --input=backups/latest/ --userId=1d64c3d2-85fe-4a83-a649-e446b07b3aae',
	];
