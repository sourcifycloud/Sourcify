...
import type { INode, INodeCredentialsDetails } from 'sourcify-workflow';
...
export class ImportWorkflowsCommand extends BaseCommand {
	...
	static examples = [
		'$ sourcify import:workflow --input=file.json',
		'$ sourcify import:workflow --separate --input=backups/latest/',
		'$ sourcify import:workflow --input=file.json --userId=1d64c3d2-85fe-4a83-a649-e446b07b3aae',
		'$ sourcify import:workflow --separate --input=backups/latest/ --userId=1d64c3d2-85fe-4a83-a649-e446b07b3aae',
	];
