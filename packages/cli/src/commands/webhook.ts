...
import { LoggerProxy, sleep } from 'sourcify-workflow';
...
export class Webhook extends BaseCommand {
	static description = 'Starts sourcify webhook process. Intercepts only production URLs.';

	static examples = ['$ sourcify webhook'];
	...
	/**
	 * Stops sourcify in a graceful way.
