...
import type { EventMessageTypeNames, JsonObject } from 'sourcify-workflow';
...
export abstract class AbstractEventMessage {
	 ...
	 * @param props.eventName The specific events name e.g. "sourcify.workflow.workflowStarted"
