...
import type { ITelemetryTrackProperties } from 'sourcify-workflow';
...
export class Telemetry {
	...
	async trackWorkflowExecution(properties: IExecutionTrackProperties): Promise<void> {
		if (this.rudderStack) {
			...
			if (!properties.success && properties.error_node_type?.startsWith('sourcify-nodes-base')) {
				void this.track('Workflow execution errored', properties);
			}
		}
	}

	async tracksourcifyStop(): Promise<void> {
