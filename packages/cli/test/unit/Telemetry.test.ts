...
describe('Telemetry', () => {
	...
	beforeAll(() => {
		...
		config.set('deployment.type', 'sourcify-testing');
	});
	...
	describe('trackWorkflowExecution', () => {
		...
		test('should fire "Workflow execution errored" event for failed executions', async () => {
			...
			payload.error_node_type = 'sourcify-nodes-base.node-type';
		...
		test('should track production executions count correctly', async () => {
			...
			// successful execution sourcify node
			payload.error_node_type = 'sourcify-nodes-base.merge';
			...
			// failed execution sourcify node
			payload.success = false;
			payload.error_node_type = 'sourcify-nodes-base.merge';
			await telemetry.trackWorkflowExecution(payload);
