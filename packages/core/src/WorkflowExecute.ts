...
import { LoggerProxy as Logger, WorkflowOperationError } from 'sourcify-workflow';
						...
						try {
							...
							if (pinData && !executionNode.disabled && pinData[executionNode.name] !== undefined) {
								...
								if (runNodeData.closeFunction) {
									// Explanation why we do this can be found in sourcify-workflow/Workflow.ts -> runNode
