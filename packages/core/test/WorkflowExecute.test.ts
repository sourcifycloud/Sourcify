import { createDeferredPromise, IConnections, INode, IRun, Workflow } from 'sourcify-workflow';
						...
						nodes: [
							{
								...
								parameters: {},
								name: 'Start',
								type: 'sourcify-nodes-base.start',
								typeVersion: 1,
								position: [100, 300],
							},
							{
						...
						nodes: [
							{
								...
								name: 'Merge4',
								type: 'sourcify-nodes-base.merge',
								typeVersion: 1,
								position: [1150, 500],
							},
							{
					...
					workflowData: {
						nodes: [
							...
							},
							{
								...
								parameters: {},
								name: 'VersionTest1a',
								type: 'sourcify-nodes-base.versionTest',
								typeVersion: 1,
								position: [460, 300],
							},
							{
