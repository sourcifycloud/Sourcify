	...
	<div class="sourcify-markdown">
		...
		<div v-else :class="$style.markdown">
			<div v-for="(block, index) in loadingBlocks" :key="index">
				<sourcify-loading :loading="loading" :rows="loadingRows" animated variant="p" />
...
<script lang="ts">
import sourcifyLoading from '../sourcifyLoading';
