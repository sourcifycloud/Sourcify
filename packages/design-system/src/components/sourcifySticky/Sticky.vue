<template>
	<div
		:class="{ 'sourcify-sticky': true, [$style.sticky]: true, [$style.clickable]: !isResizing }"
		:style="styles"
		@keydown.prevent
	>
		<sourcify-resize-wrapper
		...
		>
			<template>
				...
				<div v-if="editMode && shouldShowFooter" :class="$style.footer">
					<sourcify-text size="xsmall" aligh="right">
...
import sourcifyMarkdown from '../sourcifyMarkdown';
import sourcifyResizeWrapper from '../sourcifyResizeWrapper';
import sourcifyText from '../sourcifyText';
import Locale from '../../mixins/locale';
import { defineComponent } from 'vue';

export default defineComponent({
	name: 'sourcify-sticky',
	mixins: [Locale],
	props: {
		content: {
			type: String,
