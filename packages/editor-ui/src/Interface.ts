...
export * from 'sourcify-design-system/types';
...
// Simple version of sourcify-workflow.Workflow
...
export interface IsourcifyPrompts {
	message: string;
	title: string;
...
export interface IsourcifyValueSurveyData {
	[key: string]: string;
}

export interface IsourcifyPromptResponse {
	updated: boolean;
}
...
export interface IsourcifyUISettings {
	...
	deployment?: {
		type: string | 'default' | 'sourcify-internal' | 'cloud' | 'desktop_mac' | 'desktop_win';
	};
...
export interface ISettingsState {
	settings: IsourcifyUISettings;
	promptsData: IsourcifyPrompts;
	userManagement: IUserManagementConfig;
