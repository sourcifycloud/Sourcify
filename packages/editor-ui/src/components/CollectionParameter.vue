	...
	<div @keydown.stop class="collection-parameter">
		<div class="collection-parameter-wrapper">
			<div v-if="getProperties.length === 0" class="no-items-exist">
				<sourcify-text size="small">{{ $locale.baseText('collectionParameter.noProperties') }}</sourcify-text>
			</div>
...
import { deepCopy, INodeProperties, INodePropertyOptions } from 'sourcify-workflow';
