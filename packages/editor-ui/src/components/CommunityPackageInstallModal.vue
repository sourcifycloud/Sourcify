		...
		<template #content>
			<div :class="[$style.descriptionContainer, 'p-s']">
				<div>
					...
					<sourcify-link :to="COMMUNITY_NODES_INSTALLATION_DOCS_URL" @click="onMoreInfoTopClick">
			...
			<div :class="[$style.formContainer, 'mt-m']">
				...
				>
					<sourcify-text>
						{{ $locale.baseText('settings.communityNodes.installModal.checkbox.label') }} </sourcify-text
					><br />
					<sourcify-link :to="COMMUNITY_NODES_RISKS_DOCS_URL" @click="onLearnMoreLinkClick">{{
						$locale.baseText('_reusableDynamicText.moreInfo')
					}}</sourcify-link>
				</el-checkbox>
			</div>
