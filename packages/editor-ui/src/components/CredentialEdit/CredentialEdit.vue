		...
		<template #content>
			<div :class="$style.container" data-test-id="credential-edit-dialog">
				<div :class="$style.sidebar">
					<sourcify-menu mode="tabs" :items="sidebarItems" @select="onTabSelect"></sourcify-menu>
				</div>
...
import { createEventBus, IMenuItem } from 'sourcify-design-system';
	...
	methods: {
		...
		async oAuthCredentialAuthorize() {
			...
			const receiveMessage = (event: MessageEvent) => {
				// // TODO: Add check that it came from sourcify
