...
<template>
	<div :class="$style.filter">
		<sourcify-popover trigger="click" :placement="popoverPlacement">
			<template #reference>
				<sourcify-button
					icon="filter"
					type="tertiary"
				...
				>
					<sourcify-badge
						...
						>{{ countSelectedFilterProps }}</sourcify-badge
					>
			...
			<div data-test-id="execution-filter-form">
				...
				<div :class="$style.group">
					<sourcify-tooltip placement="right">
						<template #content>
							<i18n tag="span" path="executionsFilter.customData.docsTooltip">
								<template #link>
									<a
										target="_blank"
										href="https://docs.sourcify.io/workflows/executions/custom-executions-data/"
									>
						...
						<span :class="$style.label">
							...
							<sourcify-icon :class="$style.tooltipIcon" icon="question-circle" size="small" />
						</span>
					</sourcify-tooltip>
					<div :class="$style.subGroup">
						...
						<sourcify-tooltip :disabled="isAdvancedExecutionFilterEnabled" placement="top">
							<template #content>
