	...
	>
		...
		>
			<div :class="$style.description">
				<sourcify-text color="text-dark" :bold="true" size="medium" data-test-id="execution-time">
				...
				<div :class="$style.executionStatus">
					...
					/>
					<sourcify-text :class="$style.statusLabel" size="small">{{
				...
				<div v-if="execution.mode === 'retry'">
					<sourcify-text :color="isActive ? 'text-dark' : 'text-base'" size="small">
			...
			<div :class="$style.icons">
				...
				/>
				<sourcify-tooltip v-if="execution.mode === 'manual'" placement="top">
					<template #content>
