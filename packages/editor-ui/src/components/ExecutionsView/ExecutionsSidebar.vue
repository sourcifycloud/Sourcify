<template>
	...
	>
		<div :class="$style.heading">
			<sourcify-heading tag="h2" size="medium" color="text-dark">
		...
		>
			...
			<div v-if="executions.length === 0" :class="$style.noResultsContainer">
				<sourcify-text color="text-base" size="medium" align="center">
...
import type { IExecutionsSummary } from 'sourcify-workflow';
