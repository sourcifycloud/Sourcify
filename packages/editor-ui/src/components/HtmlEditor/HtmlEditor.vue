...
import { htmlLanguage, autoCloseTags, html } from 'codemirror-lang-html-sourcify';
...
import { sourcifyCompletionSources } from '@/plugins/codemirror/completions/addCompletions';
		...
		extensions(): Extension[] {
			function htmlWithCompletions() {
				return new LanguageSupport(
					htmlLanguage,
					sourcifyCompletionSources().map((source) => htmlLanguage.data.of(source)),
				);
			}
