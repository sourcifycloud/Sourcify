	...
	>
		...
		<template #node-not-run>
			<div :class="$style.noOutputData" v-if="parentNodes.length">
				...
				<sourcify-text v-if="!readOnly" tag="div" size="small">
			...
			<div :class="$style.notConnected" v-else>
				...
				<sourcify-text tag="div">
					...
					<a
						href="https://docs.sourcify.io/workflows/connections/"
						target="_blank"
...
import { IConnectedNode, INodeTypeDescription, Workflow } from 'sourcify-workflow';
