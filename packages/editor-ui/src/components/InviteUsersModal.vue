	...
	>
		<template #content>
			<div v-if="showInviteUrls">
				<sourcify-users-list :users="invitedUsers">
			...
			<sourcify-form-inputs
				...
				@submit="onSubmit"
			/>
			<sourcify-info-tip v-if="!settingsStore.isSmtpSetup" class="mt-s">
				<i18n path="settings.users.setupSMTPInfo">
					<template #link>
						<a
							href="https://docs.sourcify.io/reference/user-management.html#step-one-smtp"
							target="_blank"
						>
