<template>
	<sourcify-tabs :options="options" :value="value" @input="onTabSelect" @tooltipClick="onTooltipClick" />
</template>
...
export default mixins(externalHooks).extend({
	...
	computed: {
		...
		documentationUrl(): string {
			...
			const utmTags =
				'?utm_source=sourcify_app&utm_medium=node_settings_modal-credential_link' +
				'&utm_campaign=' +
				nodeType.name;
