<template>
	<span :class="$style.container" data-test-id="node-title-container" @click="onEdit">
		...
		<sourcify-popover placement="right" width="200" :value="editName" :disabled="!editable">
			<div
			...
			>
				<sourcify-text :bold="true" color="text-base" tag="div">{{
					$locale.baseText('ndv.title.renameNode')
				}}</sourcify-text>
				<sourcify-input ref="input" size="small" v-model="newName" data-test-id="node-rename-input" />
