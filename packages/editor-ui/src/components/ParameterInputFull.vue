...
import { IsourcifyButton, INodeUi, IRunDataDisplayMode, IUpdateInformation } from '@/Interface';
...
import { INodeParameters, INodeProperties, INodePropertyMode, IParameterLabel } from 'sourcify-workflow';
...
export default mixins(showMessage, externalHooks).extend({
	...
	data() {
		return {
			...
			dataMappingTooltipButtons: [] as IsourcifyButton[],
