		...
		>
			<template #error>
				<div :class="$style.error">
					<sourcify-text color="text-dark" align="center" tag="div">
						{{ $locale.baseText('resourceLocator.mode.list.error.title') }}
					</sourcify-text>
					<sourcify-text size="small" color="text-base" v-if="hasCredential">
			...
			>
				...
				<div :class="$style.inputContainer">
					...
					<div v-else-if="urlValue" :class="$style.openResourceLink">
						<sourcify-link theme="text" @click.stop="openResource(urlValue)">
