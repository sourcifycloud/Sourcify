...
export const sourcify_IO_BASE_URL = 'https://api.sourcify.io/api/';
export const DOCS_DOMAIN = 'docs.sourcify.io';
...
export const NPM_KEYWORD_SEARCH_URL =
	'https://www.npmjs.com/search?q=keywords%3Asourcify-community-node-package';
export const sourcify_QUEUE_MODE_DOCS_URL = `https://${DOCS_DOMAIN}/hosting/scaling/queue-mode/`;
...
export const CUSTOM_NODES_DOCS_URL = `https://${DOCS_DOMAIN}/integrations/creating-nodes/code/create-sourcify-nodes-module/`;
export const EXPRESSIONS_DOCS_URL = `https://${DOCS_DOMAIN}/code-examples/expressions/`;
export const sourcify_PRICING_PAGE_URL = 'https://sourcify.io/pricing';

// node types
export const BAMBOO_HR_NODE_TYPE = 'sourcify-nodes-base.bambooHr';
export const CALENDLY_TRIGGER_NODE_TYPE = 'sourcify-nodes-base.calendlyTrigger';
export const CODE_NODE_TYPE = 'sourcify-nodes-base.code';
export const CRON_NODE_TYPE = 'sourcify-nodes-base.cron';
export const CLEARBIT_NODE_TYPE = 'sourcify-nodes-base.clearbit';
export const FILTER_NODE_TYPE = 'sourcify-nodes-base.filter';
export const FUNCTION_NODE_TYPE = 'sourcify-nodes-base.function';
export const GITHUB_TRIGGER_NODE_TYPE = 'sourcify-nodes-base.githubTrigger';
export const GIT_NODE_TYPE = 'sourcify-nodes-base.git';
export const GOOGLE_SHEETS_NODE_TYPE = 'sourcify-nodes-base.googleSheets';
export const ERROR_TRIGGER_NODE_TYPE = 'sourcify-nodes-base.errorTrigger';
export const ELASTIC_SECURITY_NODE_TYPE = 'sourcify-nodes-base.elasticSecurity';
export const EMAIL_SEND_NODE_TYPE = 'sourcify-nodes-base.emailSend';
export const EMAIL_IMAP_NODE_TYPE = 'sourcify-nodes-base.emailReadImap';
export const EXECUTE_COMMAND_NODE_TYPE = 'sourcify-nodes-base.executeCommand';
export const HTML_NODE_TYPE = 'sourcify-nodes-base.html';
export const HTTP_REQUEST_NODE_TYPE = 'sourcify-nodes-base.httpRequest';
export const HUBSPOT_TRIGGER_NODE_TYPE = 'sourcify-nodes-base.hubspotTrigger';
export const IF_NODE_TYPE = 'sourcify-nodes-base.if';
export const INTERVAL_NODE_TYPE = 'sourcify-nodes-base.interval';
export const ITEM_LISTS_NODE_TYPE = 'sourcify-nodes-base.itemLists';
export const JIRA_NODE_TYPE = 'sourcify-nodes-base.jira';
export const JIRA_TRIGGER_NODE_TYPE = 'sourcify-nodes-base.jiraTrigger';
export const MICROSOFT_EXCEL_NODE_TYPE = 'sourcify-nodes-base.microsoftExcel';
export const MANUAL_TRIGGER_NODE_TYPE = 'sourcify-nodes-base.manualTrigger';
export const MICROSOFT_TEAMS_NODE_TYPE = 'sourcify-nodes-base.microsoftTeams';
export const sourcify_NODE_TYPE = 'sourcify-nodes-base.sourcify';
export const NO_OP_NODE_TYPE = 'sourcify-nodes-base.noOp';
export const STICKY_NODE_TYPE = 'sourcify-nodes-base.stickyNote';
export const NOTION_TRIGGER_NODE_TYPE = 'sourcify-nodes-base.notionTrigger';
export const PAGERDUTY_NODE_TYPE = 'sourcify-nodes-base.pagerDuty';
export const SALESFORCE_NODE_TYPE = 'sourcify-nodes-base.salesforce';
export const SEGMENT_NODE_TYPE = 'sourcify-nodes-base.segment';
export const SET_NODE_TYPE = 'sourcify-nodes-base.set';
export const SCHEDULE_TRIGGER_NODE_TYPE = 'sourcify-nodes-base.scheduleTrigger';
export const SERVICENOW_NODE_TYPE = 'sourcify-nodes-base.serviceNow';
export const SLACK_NODE_TYPE = 'sourcify-nodes-base.slack';
export const SPREADSHEET_FILE_NODE_TYPE = 'sourcify-nodes-base.spreadsheetFile';
export const SPLIT_IN_BATCHES_NODE_TYPE = 'sourcify-nodes-base.splitInBatches';
export const START_NODE_TYPE = 'sourcify-nodes-base.start';
export const SWITCH_NODE_TYPE = 'sourcify-nodes-base.switch';
export const THE_HIVE_TRIGGER_NODE_TYPE = 'sourcify-nodes-base.theHiveTrigger';
export const QUICKBOOKS_NODE_TYPE = 'sourcify-nodes-base.quickbooks';
export const WAIT_NODE_TYPE = 'sourcify-nodes-base.wait';
export const WEBHOOK_NODE_TYPE = 'sourcify-nodes-base.webhook';
export const WORKABLE_TRIGGER_NODE_TYPE = 'sourcify-nodes-base.workableTrigger';
export const WORKFLOW_TRIGGER_NODE_TYPE = 'sourcify-nodes-base.workflowTrigger';
export const EXECUTE_WORKFLOW_TRIGGER_NODE_TYPE = 'sourcify-nodes-base.executeWorkflowTrigger';
export const WOOCOMMERCE_TRIGGER_NODE_TYPE = 'sourcify-nodes-base.wooCommerceTrigger';
export const XERO_NODE_TYPE = 'sourcify-nodes-base.xero';
export const ZENDESK_NODE_TYPE = 'sourcify-nodes-base.zendesk';
export const ZENDESK_TRIGGER_NODE_TYPE = 'sourcify-nodes-base.zendeskTrigger';
...
export const REQUEST_NODE_FORM_URL = 'https://sourcify-community.typeform.com/to/K1fBVTZ3';
export const ASK_AI_WAITLIST_URL = 'https://sourcify-community.typeform.com/to/odKU4oDR';

// General
export const INSTANCE_ID_HEADER = 'sourcify-instance-id';
...
export const LOCAL_STORAGE_ACTIVATION_FLAG = 'sourcify_HIDE_ACTIVATION_ALERT';
export const LOCAL_STORAGE_PIN_DATA_DISCOVERY_NDV_FLAG = 'sourcify_PIN_DATA_DISCOVERY_NDV';
export const LOCAL_STORAGE_PIN_DATA_DISCOVERY_CANVAS_FLAG = 'sourcify_PIN_DATA_DISCOVERY_CANVAS';
export const LOCAL_STORAGE_MAPPING_IS_ONBOARDED = 'sourcify_MAPPING_ONBOARDED';
export const LOCAL_STORAGE_MAIN_PANEL_RELATIVE_WIDTH = 'sourcify_MAIN_PANEL_RELATIVE_WIDTH';
export const LOCAL_STORAGE_ACTIVE_MODAL = 'sourcify_ACTIVE_MODAL';
export const LOCAL_STORAGE_THEME = 'sourcify_THEME';
export const LOCAL_STORAGE_EXPERIMENT_OVERRIDES = 'sourcify_EXPERIMENT_OVERRIDES';
export const BASE_NODE_SURVEY_URL = 'https://sourcify-community.typeform.com/to/BvmzxqYv#nodename=';
...
Love sourcify? Help us build the future of automation! https://sourcify.io/careers?utm_source=sourcify_user&utm_medium=console_output
`;
...
export const TEMPLATES_NODES_FILTER = ['sourcify-nodes-base.start', 'sourcify-nodes-base.respondToWebhook'];
...
export const sourcify_SALES_EMAIL = 'sales@sourcify.io';

export const sourcify_CONTACT_EMAIL = 'contact@sourcify.io';
