import { ExpressionExtensions, NativeMethods, IDataObject, DocMetadata } from 'sourcify-workflow';
...
import { NativeDoc } from 'sourcify-workflow/src/Extensions/Extensions';
	...
	return variables.map((variable) =>
		createCompletionOption('Object', variable.key, 'keyword', {
			doc: {
				...
				docURL: 'https://docs.sourcify.io/environments/variables/',
			},
		}),
	);
};
