...
export interface sourcifyConnectorOptions extends ConnectorOptions {}
interface sourcifyConnectorPaintGeometry extends PaintGeometry {
...
export class sourcifyConnector extends AbstractConnector {
	static type = 'sourcifyConnector';
	type = sourcifyConnector.type;
	...
	constructor(public connection: Connection, params: sourcifyConnectorOptions) {
	...
	writeFlowchartSegments(paintInfo: sourcifyConnectorPaintGeometry) {
	...
	_getPaintInfo(params: ConnectorComputeParams): sourcifyConnectorPaintGeometry {
	...
	_computeBezier(paintInfo: sourcifyConnectorPaintGeometry) {
	...
	_computeFlowchart(paintInfo: sourcifyConnectorPaintGeometry) {
		this.segments = [];
		this.lastx = null;
		this.lasty = null;
