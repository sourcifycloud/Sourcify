...
export type ComputedsourcifyPlusEndpoint = [number, number, number, number, number];
interface sourcifyPlusEndpointParams extends EndpointRepresentationParams {
	dimensions: number;
...
export const sourcifyPlusEndpointType = 'sourcifyPlus';
export const EVENT_PLUS_ENDPOINT_CLICK = 'eventPlusEndpointClick';
export class sourcifyPlusEndpoint extends EndpointRepresentation<ComputedsourcifyPlusEndpoint> {
	params: sourcifyPlusEndpointParams;
	label: string;
	stalkOverlay: Overlay | null;
	messageOverlay: Overlay | null;

	constructor(endpoint: Endpoint, params: sourcifyPlusEndpointParams) {
	...
	static type = sourcifyPlusEndpointType;
	type = sourcifyPlusEndpoint.type;
...
export const sourcifyPlusEndpointHandler: EndpointHandler<sourcifyPlusEndpoint, ComputedsourcifyPlusEndpoint> = {
	type: sourcifyPlusEndpoint.type,
	cls: sourcifyPlusEndpoint,
	compute: (ep: sourcifyPlusEndpoint, anchorPoint: AnchorPlacement): ComputedsourcifyPlusEndpoint => {
	...
	getParams: (ep: sourcifyPlusEndpoint): sourcifyPlusEndpointParams => {
		return ep.params;
	},
};
