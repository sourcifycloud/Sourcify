...
import { ITelemetrySettings, ITelemetryTrackProperties, IDataObject } from 'sourcify-workflow';
...
export class Telemetry {
	...
	init(
		...
		this.initRudderStack(key, url, {
			...
			configUrl: 'https://api-rs.sourcify.io',
			...logging,
		});
	...
	private initRudderStack(key: string, url: string, options: IDataObject) {
		...
		this.rudderStack.loadJS = () => {
			...
			script.async = !0;
			script.src = 'https://cdn-rs.sourcify.io/v1/ra.min.js';
