...
import { IsourcifyUISettings } from '@/Interface';
import { useRootStore } from '@/stores/sourcifyRootStore';
import { useTelemetryStore } from '@/stores/telemetry';

const DEFAULT_POSTHOG_SETTINGS: IsourcifyUISettings['posthog'] = {
	enabled: true,
	apiHost: 'host',
	apiKey: 'key',
	autocapture: false,
