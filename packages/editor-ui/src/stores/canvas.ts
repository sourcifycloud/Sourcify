...
import { sourcifyPlusEndpointHandler } from '@/plugins/endpoints/sourcifyPlusEndpointType';
import * as sourcifyPlusEndpointRenderer from '@/plugins/endpoints/sourcifyPlusEndpointRenderer';
import { sourcifyConnector } from '@/plugins/connectors/sourcifyCustomConnector';
...
export const useCanvasStore = defineStore('canvas', () => {
	...
	Connectors.register(sourcifyConnector.type, sourcifyConnector);
	sourcifyPlusEndpointRenderer.register();
	EndpointFactory.registerHandler(sourcifyPlusEndpointHandler);
