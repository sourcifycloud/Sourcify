...
export class AmqpTrigger implements INodeType {
	description: INodeTypeDescription = {
		...
		properties: [
			...
			},
			{
				...
				type: 'string',
				default: '',
				placeholder: 'for durable/persistent topic subscriptions, example: "sourcify"',
	...
	async trigger(this: ITriggerFunctions): Promise<ITriggerResponse> {
		...
		// The "closeFunction" function gets called by sourcify whenever
		...
		// The "manualTriggerFunction" function gets called by sourcify
