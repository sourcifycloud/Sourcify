import type { IDataObject, INodeProperties } from 'sourcify-workflow';
		...
		options: [
			{
				...
				type: 'multiOptions',
				description:
					'The group to assign this collection to. Choose from the list, or specify IDs using an <a href="https://docs.sourcify.io/code-examples/expressions/">expression</a>.',
				default: [],
				typeOptions: {
