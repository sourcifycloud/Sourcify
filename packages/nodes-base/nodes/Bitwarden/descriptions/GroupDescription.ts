		...
		options: [
			{
				...
				type: 'multiOptions',
				description:
					'The collections to assign to this group. Choose from the list, or specify IDs using an <a href="https://docs.sourcify.io/code-examples/expressions/">expression</a>.',
				default: [],
				typeOptions: {
