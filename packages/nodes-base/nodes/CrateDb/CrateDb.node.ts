	...
	description: INodeTypeDescription = {
		...
		properties: [
			...
			// ----------------------------------
			{
				...
				required: true,
				description:
					'The SQL query to execute. You can use sourcify expressions or $1 and $2 in conjunction with query parameters.',
			},
				...
				options: [
					{
						...
						default: 'multiple',
						description:
							'The way queries should be sent to database. Can be used in conjunction with <b>Continue on Fail</b>. See <a href="https://docs.sourcify.io/integrations/builtin/app-nodes/sourcify-nodes-base.cratedb/">the docs</a> for more examples.',
					},
					{
		...
		if (operation === 'executeQuery') {
			...
			if (mode === 'independently') {
				...
				const where =
					' WHERE ' +
					updateKeys
						// eslint-disable-next-line sourcify-local-rules/no-interpolation-in-regular-string
