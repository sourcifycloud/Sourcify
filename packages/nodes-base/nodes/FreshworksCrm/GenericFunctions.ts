...
// /**
//  * Adjust attendee data from sourcify UI to the format expected by Freshworks CRM API.
//  */
...
/**
 * Adjust account data from sourcify UI to the format expected by Freshworks CRM API.
 */
