			...
			},
			{
				...
				modes: [
					...
					},
					{
						...
						name: 'url',
						type: 'string',
						placeholder: 'e.g. https://github.com/sourcifycloud',
						extractValue: {
							type: 'regex',
			...
			},
			{
				...
				modes: [
					...
					},
					{
						...
						name: 'url',
						type: 'string',
						placeholder: 'e.g. https://github.com/sourcifycloud/sourcify',
						extractValue: {
							type: 'regex',
			...
			async create(this: IHookFunctions): Promise<boolean> {
				...
				if (webhookUrl.includes('//localhost')) {
					throw new NodeOperationError(
						this.getNode(),
						'The Webhook can not work on "localhost". Please, either setup sourcify on a custom domain or start with "--tunnel"!',
					);
				}
