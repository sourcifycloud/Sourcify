...
import { BINARY_ENCODING, jsonParse, NodeApiError, NodeOperationError, sleep } from 'sourcify-workflow';
							...
							values: [
								{
									...
									default: '',
									description:
										'ID of the field to set. Choose from the list, or specify an ID using an <a href="https://docs.sourcify.io/code-examples/expressions/">expression</a>.',
								},
								{
									displayName: 'Value',
									name: 'value',
				...
				},
				{
					...
					options: [
						...
						},
						{
							...
							noDataExpression: true,
							default: false,
							// eslint-disable-next-line sourcify-nodes-base/node-param-description-wrong-for-ignore-ssl-issues
							description:
							...
							options: [
								{
									name: 'No Brackets',
									value: 'repeat',
									// eslint-disable-next-line sourcify-nodes-base/node-param-description-lowercase-first-char
