		...
		options: [
			{
				...
				values: [
					...
					},
					{
						...
						default: [],
						description:
							'List of users to receive the notification. Choose from the list, or specify IDs using an <a href="https://docs.sourcify.io/code-examples/expressions/">expression</a>.',
					},
					{
						...
						default: [],
						description:
							'List of groups to receive the notification. Choose from the list, or specify IDs using an <a href="https://docs.sourcify.io/code-examples/expressions/">expression</a>.',
					},
				],
			},
		],
