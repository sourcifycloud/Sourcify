...
export const postFields: INodeProperties[] = [
	...
	},
	{
		...
		required: true,
		description:
			'Person as which the post should be posted as. Choose from the list, or specify an ID using an <a href="https://docs.sourcify.io/code-examples/expressions/">expression</a>.',
		displayOptions: {
			show: {
				operation: ['create'],
				postAs: ['person'],
