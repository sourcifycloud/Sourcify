import type { IDataObject, INode } from 'sourcify-workflow';
...
const node: INode = {
	...
	name: 'Postgres node',
	typeVersion: 2,
	type: 'sourcify-nodes-base.postgres',
	position: [60, 760],
	parameters: {
...
describe('Test PostgresV2, parsePostgresError', () => {
	...
	it('should update message with syntax error', () => {
		// eslint-disable-next-line sourcify-local-rules/no-unneeded-backticks
