...
export const optionsCollection: INodeProperties = {
	...
	options: [
		...
		},
		{
			...
			default: '',
			description:
				'Comma-separated list of the values you want to use as query parameters. <a href="https://docs.sourcify.io/integrations/builtin/app-nodes/sourcify-nodes-base.postgres/#use-query-parameters">More info</a>.',
