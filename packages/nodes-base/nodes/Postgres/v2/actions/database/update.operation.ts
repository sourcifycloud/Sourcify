...
const properties: INodeProperties[] = [
	...
	{
		// eslint-disable-next-line sourcify-nodes-base/node-param-display-name-miscased, sourcify-nodes-base/node-param-display-name-wrong-for-dynamic-options
		displayName: 'Column to Match On',
		name: 'columnToMatchOn',
		type: 'options',
		required: true,
		description:
			'The column to compare when finding the rows to update. Choose from the list, or specify an ID using an <a href="https://docs.sourcify.io/code-examples/expressions/">expression</a>.',
		typeOptions: {
