...
export class SplitInBatchesV1 implements INodeType {
	description: INodeTypeDescription = {
		...
		properties: [
			{
				displayName:
					'You may not need this node — sourcify nodes automatically run once for each input item. <a href="https://docs.sourcify.io/getting-started/key-concepts/looping.html#using-loops-in-sourcify" target="_blank">More info</a>',
