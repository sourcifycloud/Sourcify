...
/**
 * Convert sourcify's address object into a Stripe API request shipping object.
 */
...
/**
 * Convert sourcify's `fixedCollection` metadata object into a Stripe API request metadata object.
 */
...
/**
 * Convert sourcify's shipping object into a Stripe API request shipping object.
 */
...
/**
 * Make sourcify's charge fields compliant with the Stripe API request object.
 */
export const adjustChargeFields = flow([adjustShipping, adjustMetadata]);

/**
 * Make sourcify's customer fields compliant with the Stripe API request object.
 */
