	...
	},
	{
		...
		options: [
			...
			},
			{
				...
				default: [],
				description:
					'The users that will attached to the thread. Choose from the list, or specify IDs using an <a href="https://docs.sourcify.io/code-examples/expressions/">expression</a>.',
			},
			{
