	...
	description: INodeTypeDescription = {
		...
		properties: [
			...
			},
			{
				...
				required: true,
				description:
					'Form which should trigger workflow on submission. Choose from the list, or specify an ID using an <a href="https://docs.sourcify.io/code-examples/expressions/">expression</a>.',
			},
			{
				...
				type: 'boolean',
				default: true,
				// eslint-disable-next-line sourcify-nodes-base/node-param-description-wrong-for-simplify
				description:
	...
	webhookMethods = {
		default: {
			...
			async create(this: IHookFunctions): Promise<boolean> {
				...
				const formId = this.getNodeParameter('formId') as string;
				const webhookId = 'sourcify-' + Math.random().toString(36).substring(2, 15);
