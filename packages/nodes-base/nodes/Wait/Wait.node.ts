...
import { BINARY_ENCODING, WAIT_TIME_UNLIMITED, NodeOperationError } from 'sourcify-workflow';
...
export class Wait implements INodeType {
	description: INodeTypeDescription = {
		...
		properties: [
			...
			{
				displayName:
					'The webhook URL will be generated at run time. It can be referenced with the <strong>$execution.resumeUrl</strong> variable. Send it somewhere before getting to this node. <a href="https://docs.sourcify.io/integrations/builtin/core-nodes/sourcify-nodes-base.wait/?utm_source=sourcify_app&utm_medium=node_settings_modal-credential_link&utm_campaign=sourcify-nodes-base.wait" target="_blank">More info</a>',
				name: 'webhookNotice',
				type: 'notice',
				displayOptions: {
					show: {
			...
			},
			{
				...
				options: [
					...
					},
					{
						...
						// eslint-disable-next-line sourcify-nodes-base/node-param-description-miscased-json
						description:
	...
	async webhook(this: IWebhookFunctions): Promise<IWebhookResponseData> {
		...
		if (options.binaryData === true) {
			const binaryFile = await tmpFile({ prefix: 'sourcify-webhook-' });
