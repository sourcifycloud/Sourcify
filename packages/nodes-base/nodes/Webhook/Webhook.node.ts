...
import { BINARY_ENCODING, NodeOperationError } from 'sourcify-workflow';
...
export class Webhook implements INodeType {
	description: INodeTypeDescription = {
		...
		properties: [
			...
			{
				displayName:
					'Insert a \'Respond to Webhook\' node to control when and how you respond. <a href="https://docs.sourcify.io/integrations/builtin/core-nodes/sourcify-nodes-base.respondtowebhook/" target="_blank">More details</a>',
				name: 'webhookNotice',
				type: 'notice',
				displayOptions: {
					show: {
