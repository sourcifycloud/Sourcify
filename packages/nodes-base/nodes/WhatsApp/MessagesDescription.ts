...
export const messageTypeFields: INodeProperties[] = [
	...
	// ----------------------------------
	{
		...
		description: 'Use a link, an ID, or sourcify to upload an audio file',
		options: [
			{
				name: 'Link',
				value: 'useMediaLink',
	...
	},
	{
		...
		type: 'options',
		default: 'useMediaLink',
		description: 'Use a link, an ID, or sourcify to upload a document',
		options: [
			{
				name: 'Link',
				value: 'useMediaLink',
			...
			},
			{
				...
				name: 'sourcify',
				value: 'useMediasourcify',
				description: 'Upload a binary file on the item being processed in sourcify',
			},
		],
		displayOptions: {
			show: {
	...
	},
	{
		...
		type: 'options',
		default: 'useMediaLink',
		description: 'Use a link, an ID, or sourcify to upload an image',
		options: [
			{
				name: 'Link',
				value: 'useMediaLink',
	...
	},
	{
		...
		type: 'options',
		default: 'useMediaLink',
		description: 'Use a link, an ID, or sourcify to upload a video',
		options: [
			{
				name: 'Link',
				value: 'useMediaLink',
