				...
				options: [
					{
						...
						name: 'fields',
						description:
							'The fields to return the values of. Choose from the list, or specify IDs using an <a href="https://docs.sourcify.io/code-examples/expressions/">expression</a>.',
						type: 'multiOptions',
						default: [],
						typeOptions: {
			...
			async create(this: IHookFunctions): Promise<boolean> {
				...
				if (service === 'support') {
					...
					const bodyTrigger: IDataObject = {
						trigger: {
							title: `sourcify-webhook:${urlParts.pathname}`,
							conditions: {
								all: resultAll,
								any: resultAny,
							},
