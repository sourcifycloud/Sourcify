...
const createOperation: INodeProperties[] = [
	{
		...
		type: 'string',
		default: '',
		placeholder: 'e.g. sourcify account',
		required: true,
		displayOptions: {
			show: {
				resource: ['credential'],
	...
	},
	{
		...
		description:
			"The available types depend on nodes installed on the sourcify instance. Some built-in types include e.g. 'githubApi', 'notionApi', and 'slackApi'.",
	},
	{
		displayName: 'Data',
		name: 'data',
		...
		default: '',
		placeholder:
			'// e.g. for sourcifyApi \n{\n  "apiKey": "my-sourcify-api-key",\n  "baseUrl": "https://<name>.app.sourcify.cloud/api/v1",\n}',
		required: true,
		typeOptions: {
