...
export async function apiRequest(
	...
	type sourcifyApiCredentials = {
		apiKey: string;
		baseUrl: string;
	};

	const credentials = (await this.getCredentials('sourcifyApi')) as sourcifyApiCredentials;
	...
	try {
		return await this.helpers.requestWithAuthentication.call(this, 'sourcifyApi', options);
	} catch (error) {
...
/**
 * Get a cursor-based paginator to use with sourcify 'getAll' type endpoints.
 *
