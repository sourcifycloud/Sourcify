import type { ILoadOptionsFunctions, INodeListSearchResult, INodeProperties } from 'sourcify-workflow';
...
export const workflowIdLocator: INodeProperties = {
	...
	modes: [
		...
		},
		{
			...
			name: 'url',
			type: 'string',
			placeholder: 'https://myinstance.app.sourcify.cloud/workflow/1',
			validation: [
				{
					type: 'regex',
					properties: {
