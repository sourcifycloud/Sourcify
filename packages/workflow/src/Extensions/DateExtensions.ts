...
endOfMonth.doc = {
	...
	docURL:
		'https://docs.sourcify.io/code-examples/expressions/data-transformation-functions/dates/#date-endOfMonth',
};
...
isDst.doc = {
	...
	docURL:
		'https://docs.sourcify.io/code-examples/expressions/data-transformation-functions/dates/#date-isDst',
};
...
isWeekend.doc = {
	...
	docURL:
		'https://docs.sourcify.io/code-examples/expressions/data-transformation-functions/dates/#date-isWeekend',
};
...
beginningOf.doc = {
	...
	docURL:
		'https://docs.sourcify.io/code-examples/expressions/data-transformation-functions/dates/#date-beginningOf',
};
...
extract.doc = {
	...
	docURL:
		'https://docs.sourcify.io/code-examples/expressions/data-transformation-functions/dates/#date-extract',
};
...
format.doc = {
	...
	docURL:
		'https://docs.sourcify.io/code-examples/expressions/data-transformation-functions/dates/#date-format',
};
...
isBetween.doc = {
	...
	docURL:
		'https://docs.sourcify.io/code-examples/expressions/data-transformation-functions/dates/#date-isBetween',
};
...
isInLast.doc = {
	...
	docURL:
		'https://docs.sourcify.io/code-examples/expressions/data-transformation-functions/dates/#date-isInLast',
};
...
minus.doc = {
	...
	docURL:
		'https://docs.sourcify.io/code-examples/expressions/data-transformation-functions/dates/#date-minus',
};
...
plus.doc = {
	...
	docURL:
		'https://docs.sourcify.io/code-examples/expressions/data-transformation-functions/dates/#date-plus',
};
