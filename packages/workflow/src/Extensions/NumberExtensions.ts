...
ceil.doc = {
	...
	returnType: 'number',
	docURL:
		'https://docs.sourcify.io/code-examples/expressions/data-transformation-functions/numbers/#number-ceil',
};
...
floor.doc = {
	...
	returnType: 'number',
	docURL:
		'https://docs.sourcify.io/code-examples/expressions/data-transformation-functions/numbers/#number-floor',
};
...
isEven.doc = {
	...
	returnType: 'boolean',
	docURL:
		'https://docs.sourcify.io/code-examples/expressions/data-transformation-functions/numbers/#number-isEven',
};
...
isOdd.doc = {
	...
	returnType: 'boolean',
	docURL:
		'https://docs.sourcify.io/code-examples/expressions/data-transformation-functions/numbers/#number-isOdd',
};
...
format.doc = {
	...
	docURL:
		'https://docs.sourcify.io/code-examples/expressions/data-transformation-functions/numbers/#number-format',
};
...
round.doc = {
	...
	docURL:
		'https://docs.sourcify.io/code-examples/expressions/data-transformation-functions/numbers/#number-round',
};
