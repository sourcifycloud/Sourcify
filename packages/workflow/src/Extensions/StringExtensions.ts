...
removeMarkdown.doc = {
	...
	returnType: 'string',
	docURL:
		'https://docs.sourcify.io/code-examples/expressions/data-transformation-functions/strings/#string-removeMarkdown',
};
...
removeTags.doc = {
	...
	returnType: 'string',
	docURL:
		'https://docs.sourcify.io/code-examples/expressions/data-transformation-functions/strings/#string-removeTags',
};
...
toDate.doc = {
	...
	returnType: 'Date',
	docURL:
		'https://docs.sourcify.io/code-examples/expressions/data-transformation-functions/strings/#string-toDate',
};
...
toFloat.doc = {
	...
	docURL:
		'https://docs.sourcify.io/code-examples/expressions/data-transformation-functions/strings/#string-toDecimalNumber',
};
...
toInt.doc = {
	...
	docURL:
		'https://docs.sourcify.io/code-examples/expressions/data-transformation-functions/strings/#string-toInt',
};
...
toSentenceCase.doc = {
	...
	returnType: 'string',
	docURL:
		'https://docs.sourcify.io/code-examples/expressions/data-transformation-functions/strings/#string-toSentenceCase',
};
...
toSnakeCase.doc = {
	...
	returnType: 'string',
	docURL:
		'https://docs.sourcify.io/code-examples/expressions/data-transformation-functions/strings/#string-toSnakeCase',
};
...
toTitleCase.doc = {
	...
	returnType: 'string',
	docURL:
		'https://docs.sourcify.io/code-examples/expressions/data-transformation-functions/strings/#string-toTitleCase',
};
...
urlEncode.doc = {
	...
	returnType: 'string',
	docURL:
		'https://docs.sourcify.io/code-examples/expressions/data-transformation-functions/strings/#string-urlEncode',
};
...
urlDecode.doc = {
	...
	returnType: 'string',
	docURL:
		'https://docs.sourcify.io/code-examples/expressions/data-transformation-functions/strings/#string-urlDecode',
};
...
replaceSpecialChars.doc = {
	...
	returnType: 'string',
	docURL:
		'https://docs.sourcify.io/code-examples/expressions/data-transformation-functions/strings/#string-replaceSpecialChars',
};
...
length.doc = {
	...
	returnType: 'number',
	docURL: 'https://docs.sourcify.io/code-examples/expressions/data-transformation-functions/strings',
};
...
isDomain.doc = {
	...
	returnType: 'boolean',
	docURL:
		'https://docs.sourcify.io/code-examples/expressions/data-transformation-functions/strings/#string-isDomain',
};
...
isEmail.doc = {
	...
	returnType: 'boolean',
	docURL:
		'https://docs.sourcify.io/code-examples/expressions/data-transformation-functions/strings/#string-isEmail',
};
...
isNumeric.doc = {
	...
	returnType: 'boolean',
	docURL:
		'https://docs.sourcify.io/code-examples/expressions/data-transformation-functions/strings/#string-isNumeric',
};
...
isUrl.doc = {
	...
	returnType: 'boolean',
	docURL:
		'https://docs.sourcify.io/code-examples/expressions/data-transformation-functions/strings/#string-isUrl',
};
...
isEmpty.doc = {
	...
	returnType: 'boolean',
	docURL:
		'https://docs.sourcify.io/code-examples/expressions/data-transformation-functions/strings/#string-isEmpty',
};
...
isNotEmpty.doc = {
	...
	returnType: 'boolean',
	docURL:
		'https://docs.sourcify.io/code-examples/expressions/data-transformation-functions/strings/#string-isNotEmpty',
};
...
extractEmail.doc = {
	...
	returnType: 'string',
	docURL:
		'https://docs.sourcify.io/code-examples/expressions/data-transformation-functions/strings/#string-extractEmail',
};
...
extractDomain.doc = {
	...
	returnType: 'string',
	docURL:
		'https://docs.sourcify.io/code-examples/expressions/data-transformation-functions/strings/#string-extractDomain',
};
...
extractUrl.doc = {
	...
	returnType: 'string',
	docURL:
		'https://docs.sourcify.io/code-examples/expressions/data-transformation-functions/strings/#string-extractUrl',
};
...
hash.doc = {
	...
	docURL:
		'https://docs.sourcify.io/code-examples/expressions/data-transformation-functions/strings/#string-hash',
};
...
quote.doc = {
	...
	docURL:
		'https://docs.sourcify.io/code-examples/expressions/data-transformation-functions/strings/#string-quote',
};
