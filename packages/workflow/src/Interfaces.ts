...
export namespace DeclarativeRestApiSettings {
	...
	export type ResultOptions = {
		...
		requestOperations?: IsourcifyRequestOperations;
	};
}
...
export type IExecuteResponsePromiseData = IDataObject | IsourcifyHttpFullResponse;
...
export type IsourcifyHttpResponse = IDataObject | Buffer | GenericValue | GenericValue[] | null;

export interface IsourcifyHttpFullResponse {
	body: IsourcifyHttpResponse;
	headers: IDataObject;
	statusCode: number;
	statusMessage?: string;
}

export interface IsourcifyRequestOperations {
	pagination?:
		| IsourcifyRequestOperationPaginationGeneric
		| IsourcifyRequestOperationPaginationOffset
		| ((
...
export interface IsourcifyRequestOperationPaginationBase {
	type: string;
	properties: {
		[key: string]: unknown;
	};
...
export interface IsourcifyRequestOperationPaginationGeneric extends IsourcifyRequestOperationPaginationBase {
	type: 'generic';
	properties: {
...
export interface IsourcifyRequestOperationPaginationOffset extends IsourcifyRequestOperationPaginationBase {
	type: 'offset';
	properties: {
...
namespace ExecuteFunctions {
	...
	export type GetNodeParameterFn = {
		// @TECH_DEBT: Refactor to remove this barely used overload - sourcify-5632
...
export interface ILoadOptions {
	routing?: {
		operations?: IsourcifyRequestOperations;
...
export interface INodePropertyRouting {
	operations?: IsourcifyRequestOperations; // Should be changed, does not sound right
	output?: INodeRequestOutput;
	request?: DeclarativeRestApiSettings.HttpRequestOptions;
...
export type PostReceiveAction =
	| ((
			...
			response: IsourcifyHttpFullResponse,
	  ) => Promise<INodeExecutionData[]>)
